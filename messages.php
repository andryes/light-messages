...
<div class="container">
        ...
        <div class="col-md-10 add-msg-div">
            <form action="" class="navbar-form add-msg-form" method="POST">
                ...
                <div class="form-group">
                    <input type="text" name="newtask" class="form-control add-msg-input" placeholder="Option for registered users">
                </div>
	...
	<?php // "ADD" button handler
    	if ( isset( $_POST['addnew'] ) ) {
    	    $sql = 'INSERT INTO messages (text, userid, date) VALUES ("' . $_POST['newtask'] . '", "18", "' . date("Y-m-d H:i:s") . '")';
    		$pdo->query( $sql );
    		pageReload();
    	}
    ?>
